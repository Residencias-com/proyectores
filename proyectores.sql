...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-11-2019 a las 16:33:45
...
(21, 'PM09', 'Samsung', 'LOPGHU-90', 'SELP01', 'Computo', 0),
(22, 'PM02', 'Sony', 'GOP1002', 'BCJBSK78', 'Academico', 0),
(23, 'PM10', 'Huawei', 'HLOP90S', 'GHDINW80-0', 'Computo', 0),
(39, 'PM13', 'Canon', 'HOPSL', 'SKOD89', 'Academico', 1),
...
(3, 'Admin', 'admin@hotmail.com', 'admin');
...
--
ALTER TABLE `proyectores`
  MODIFY `idproyector` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
